    ...
    <Layout title="Conrad The Programmer">
      <div className="text-center mb-4">
        ...
        <p className="text-gray-500">
          Hi, Im <strong className="text-orange-500">Conrad</strong>. A
          fulltime programmer at Adidas, I also stream, blog and create YouTube
          videos about my live as a software engineer and topics that Im
          interested in.
          <br />
          <br />
          In my spare time I write SaaS applications, check out the project
          section below to see where Im working on.
        </p>
      </div>
      ...
      {sections.map((section) => (
        <div key={section.label}>
          ...
          <ul
            ...
            key={section.label}
          >
            {section.links.map((link: Platform) => (
              <Item platform={link} key={link.href}/>
            ))}
          </ul>
